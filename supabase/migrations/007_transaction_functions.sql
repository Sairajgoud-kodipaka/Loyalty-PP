-- Function to add purchase transaction
...
DECLARE
    ...
    v_points_remaining DECIMAL(10,2); -- Track remaining points during redemption
    v_total_redeemed DECIMAL(10,2); -- Total points actually redeemed
BEGIN
    ...
    -- Save original points to redeem (before loop modifies it)
